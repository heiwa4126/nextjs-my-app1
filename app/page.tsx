...
export default async function Home() {
	return (
		<main>
			...
			<p>
				Lorem ipsum dolor sit, amet <strong>consectetur</strong> adipisicing elit. Necessitatibus
				quis quam sunt eos cumque, illum repudiandae modi ipsa nostrum quaerat facere maiores maxime
				aliquam deserunt voluptatibus placeat minus ullam similique!
			</p>
			<p>
				文章は内容本に著作する未然ますない上、<strong>利用しれ財団を</strong>
				制限者可能の投稿メディアをしればはなるあれ、<em>技術の文も</em>
				、保持さコンテンツが配信行っことにおける引用明確なますといるますで。たとえば、
				<s>対象の著作物</s>
